public class IzracunMandatov {
	...
	public static void main(String[] args) {
        String[] stranke = {"Janezov Pusacki Krozek", "Tinkin najljubsi penis", "Juretova Izgubljena Tortica", "Teina...sfaffa Kaj? Kaaaaaaj?", "Danov sladoledni vrticek", "Kriza srednjih let", "Tinkin mali prijatelcek", "Tinka pride ob 8h. Zvecer namrec", "DMT MDMA LSD PSYLOBIN SALVIA CANABIS", "GOBICE GOBICE GOBICE", "Is it me or is this tree moving", "L", "M", "N"};
    ...
    public void izpisiTabelo() {
		...
		for (int i = 0; i < this.imenaStrank.length; i++) {
			System.out.printf("%45s %4d %8.1f", this.imenaStrank[i], this.stKandidatov[i], this.odstotkiStrank[i]);
