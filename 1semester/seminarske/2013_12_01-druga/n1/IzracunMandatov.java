public class IzracunMandatov {
    ...
    public void izpisiTabelo() {
		...
		for (int i = 0; i < this.imenaStrank.length; i++) {
            ...
            if (steviloDodatnihMestPoStrankah > najvecMandatov) {
                najvecMandatov = steviloDodatnihMestPoStrankah;
                stranka = i;
            } 
        ...
        System.out.println("Najvec mandatov (" + najvecMandatov + ") je pridobila lista " + this.imenaStrank[stranka] + ".");
    }
